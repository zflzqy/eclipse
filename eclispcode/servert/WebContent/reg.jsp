...
<html>
  ...
  <body>
    <h1>用户注册</h1>
    <hr>
    <form name="regForm" action="servert/userServlet" method="post" >
			...
			<%
				if(("日期未填写").equals(session.getAttribute("fail"))){
			%>	
				<h4 align="center">日期未填写</h4>
				<%} %>
				
			 <%
				if(("密码不一致").equals(session.getAttribute("fail"))){
			%>
				<h4 align="center">密码不一致</h4>
			<% }%> 
  </body>
</html>
